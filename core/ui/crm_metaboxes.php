             ...
             $boxes = get_user_boxes($user_id); 
				foreach ($boxes as $box){ ?>
	                    ...
	                    <tr>
	                    	...
	                    	<td><?php echo $box['order_id']; ?></td>
	                        <td><?php echo $box['date_requested']; ?></td>   
	                        <td><?php echo $box['ship_status']; ?></td>
	                        
	                        
	                        <td><?php if ($box['tracking_id'] == '') { 
	                        ...
	                        <a href="/process-shipments.php" class="button add-new-h2"><?php _e('Sync Shipment', 'wp_crm'); ?></a>
             ...
             $boxes = get_user_boxes($user_id); 
				foreach ($boxes as $box){ ?>
	                    ...
	                    <tr>
	                        ...
	                        <td><?php echo $box['date_requested']; ?></td>   
	                        <td><?php echo $box['ship_status']; ?></td>
	                        <td><?php echo $box['tracking_id']; ?></td>  
