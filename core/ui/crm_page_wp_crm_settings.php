...
<div id="wp_crm_settings_tabs" class="wp_crm_settings_tabs clearfix">
  <ul class="tabs">
    ...
    <li><a href="#tab_shipping"><?php _e('ShipStation','wp_crm'); ?></a></li>
      <?php
...
<table id="" class="ud_ui_dynamic_table widefat">
 ...
 <div id="tab_shipping">
  ...
  <table class="form-table">
    ...
    <h3 class="title"><?php _e('API Keys', 'wp_crm'); ?></h3>
			<table class="form-table">
				<tbody>
					<tr valign="top">
						<th scope="row" valign="top">
							<?php _e('API Key', 'wp_crm'); ?>
						</th>
						<td>
							<input id="wp_crm[api_key]" name="wp_crm[api_key]" type="text" class="regular-text" value="<?php echo $wp_crm['api_key']; ?>"/>
							<label class="description" for="wp_crm[api_key]"><?php _e('Paste your API key.', 'wp_crm'); ?></label>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" valign="top">
							<?php _e('API Secret', 'wp_crm'); ?>
						</th>
						<td>
							<input id="wp_crm[api_secret]" name="wp_crm[api_secret]" type="text" class="regular-text" value="<?php echo $wp_crm['api_secret']; ?>"/>
							<label class="description" for="wp_crm[api_secret]"><?php _e('Paste your API secret.', 'wp_crm'); ?></label>
						</td>
					</tr>
  </table>
 </div>
